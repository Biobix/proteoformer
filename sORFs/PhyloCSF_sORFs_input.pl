...
##############
##Command-line
# ./PhyloCSF_sORFs_input.pl --sqliteRES SQLite/results.db --cores 8 --MAF_root /storage/MAF/ --tis_ids 2
...
print "The following results db folder is used                  : $CWD/$resultDB\n";
...
sub create_maf_sORF_alignments{
    ...
    foreach my $chr (sort keys %{$chrs}){
        ...
        foreach my $sorf_id (keys %{$sorfs}){
            ...
            my $sORF_align = sORF_align($sorfs,$sorf_id,$sORF_MAF,$species);
...
sub store_in_db{
    ...
    if ($species eq "fruitfly"){
        ...
        `Guinea Pig` TEXT NOT NULL default '',
        ...
        `Mouse` TEXT NOT NULL default '',
        `Guinea pig` TEXT NOT NULL default '',
        `Kangaroo rat` TEXT NOT NULL default '',
        `Pika` TEXT NOT NULL default '',
        `Rabbit` TEXT NOT NULL default '',
        `Rat` TEXT NOT NULL default '',
        `Squirrel` TEXT NOT NULL default '',
        `TreeShrew` TEXT NOT NULL default '',
        `Human` TEXT NOT NULL default '',
        `Mouse lemur` TEXT NOT NULL default '',
        `Bushbaby` TEXT NOT NULL default '',
        `Chimp` TEXT NOT NULL default '',
        `Rhesus` TEXT NOT NULL default '',
        ...
        `Elephant` TEXT NOT NULL default '',
        `Microbat` TEXT NOT NULL default '',
        `Rock hyrax` TEXT NOT NULL default '',
        `Megabat` TEXT NOT NULL default '',
        `Shrew` TEXT NOT NULL default '',
        `Dolphin` TEXT NOT NULL default '',
        `Alpaca` TEXT NOT NULL default '' )"  ;
    ...
    # Store
    foreach my $chr (sort keys %{$chrs}){
        system("sqlite3 -separator , ".$work_dir."/".$resultDB." \".import ".$TMP."/".$id."_".$chr."_sORF_maf.csv ".$table."\"")== 0 or die "system failed: $?";
    }
...
sub sORF_align {
    ...
    if ($species eq "fruitfly") {
        ...
        'hetGla2'       =>	{'' => '',},
        'cavPor3'		=>	{'PhyloCSF_name' => 'Guinea Pig',},
        'chiLan1'       =>	{'' => '',},
        'octDeg1'       =>	{'' => '',},
        ...
        'mm10'          =>	{'PhyloCSF_name' => 'Mouse',},
        'cavPor3'		=>	{'PhyloCSF_name' => 'Guinea Pig',},
        'dipOrd1'		=>	{'PhyloCSF_name' => 'Kangaroo rat',},
        'hetGla2'       =>	{'' => '',},
        ...
        'gorGor3'       =>	{'' => '',},
        'hg19'          =>	{'PhyloCSF_name' => 'Human',},
        'micMur1'		=>	{'PhyloCSF_name' => 'Mouse lemur',},
        'nomLeu2'       =>	{'' => '',},
        'otoGar3'		=>	{'PhyloCSF_name' => 'Bushbaby',},
        'panTro4'       =>	{'PhyloCSF_name' => 'Chimp',},
        'papHam1'       =>	{'' => '',},
        ...
        'myoLuc2'		=>	{'PhyloCSF_name' => 'Microbat',},
        'oviAri1'       =>	{'' => '',},
        'proCap1'		=>	{'PhyloCSF_name' => 'Rock hyrax',},
        'pteVam1'		=>	{'PhyloCSF_name' => 'Megabat',},
