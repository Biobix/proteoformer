...
if (species=='human' or species=='homo_sapiens'):
    if(int(ens_v) >= 76 and int(ens_v) <= 86):
        ...
        print("supported ensembl versions: from 74 till 86")
        sys.exit()
elif (species=='mouse' or species=='mus_musculus'):
    if(int(ens_v) >= 74 and int(ens_v) <= 86):
        ...
        print("ERROR: unsupported ensembl version: " + ens_v)
        print("supported ensembl versions: from 75 till 86")
        sys.exit()
